...
zmq::io_object_t::handle_t zmq::io_object_t::add_fd_lwip (fd_t fd_)
{
    return poller->add_fd_lwip (fd_, this);
}

void zmq::io_object_t::rm_fd_lwip (handle_t handle_)
{
    poller->rm_fd_lwip (handle_);
}

void zmq::io_object_t::set_pollin_lwip (handle_t handle_)
{
    poller->set_pollin_lwip (handle_);
}

void zmq::io_object_t::reset_pollin_lwip (handle_t handle_)
{
    poller->reset_pollin_lwip (handle_);
}

void zmq::io_object_t::set_pollout_lwip (handle_t handle_)
{
    poller->set_pollout_lwip(handle_);
}

void zmq::io_object_t::reset_pollout_lwip (handle_t handle_)
{
    poller->reset_pollout_lwip (handle_);
}
