...
uint32_t zmq::msg_t::get_remote_id ()
{
	if (u.base.type == type_lmsg)
		return u.lmsg.remote_id;
	if (u.base.type == type_cmsg)
		return u.cmsg.remote_id;
	return UINT16_MAX;
}
