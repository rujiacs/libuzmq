...
namespace zmq
{
    ...
    public:
		void set_localid(uint16_t id) { local_id = id; }
		void set_remoteid(uint16_t id) { remote_id = id; }
		uint16_t get_localid() { return local_id; }
		uint16_t get_remoteid() { return remote_id; }
